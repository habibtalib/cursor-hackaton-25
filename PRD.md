...
## 2. Problem Statement
Companies today face increasing pressure to report on ESG metrics due to regulatory mandates (CSRD, SEC), investor demands, and consumer preference. However:
...
#### **G - Governance**
- **Compliance Tracker:** Auto-mapping internal policies to external regulations (GDPR, ESG reporting standards like GRI, SASB).
...
3.  **Regulatory Scout Agent:**
    - *Trigger:* New legislation passed (e.g., EU Green Deal update).
    - *Action:* Scans new laws, compares with current company data, and generates a gap analysis report.
4.  **Report Generator Agent:**
    - *Action:* Drafts full sustainability reports (PDF/Web) tailored to specific frameworks (TCFD, ISSB) with narrative text and generated charts.
...
| F-06 | Reporting | One-click export of ESG Disclosure Report | P1 |
